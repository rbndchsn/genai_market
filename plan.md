...
| Next step | 5.3 `insights.html`: filter by theme, evidence level and source; expandable cards with summary, detail, references, related stats and terms; deep links by `#ins-NNN`. Use `GM.loadJSON`, `GM.formatRefs`, `GM.escapeHTML` from `js/shell.js`. |
...
| 2026-09-16 | Step 5.2 done: overview dashboard driven by the data files; chart colour tokens validated and added. Next step 5.3. Uncommitted. |
