...
| Next step | 5.6 `glossary.html`: alphabetical, letter index, filter by tag and search in the query string, each term with expansion, definition, tag pills, related-term chips, refs and the insights that use it; deep links `#sovereign-ai`. |
