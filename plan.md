...
| Next step | 5.9 Local run and review: serve `site/` and sweep every page (index, insights, vendors, stats, glossary, sources, search, 404) at desktop and phone width in light and dark, check internal links and anchors resolve, check the browser console for errors. Then 5.10 deploy. |
