...
| Next step | 5.7 `sources.html`: bibliography from `sources.json` (type, publisher, date, method, sample, sponsor, licence, bias note, how we use it, how many insights, stats and terms cite it), methodology (pipeline, evidence levels, chart rebuild, originality check), licensing and attribution statement, how to cite; deep links `#src-04`. |
