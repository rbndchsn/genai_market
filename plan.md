...
| Next step | 7.1 Originality review: run `python scripts/originality_check.py`, rewrite every SRC-01 hit and review the rest by hand; then `validate_data.py`, `build_chunks.py`, `build_search_index.py`, `check_site.py`, commit, and the Pages workflow republishes. |
